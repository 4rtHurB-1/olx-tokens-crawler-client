...
(він виглядає якось так C:\Program Files (x86)\Google\Chrome\Application\chrome.exe)

3. Так само скопіювати "Шлях до профілю"("Путь к профилю") і вставити його в файл configs "profilesDir"
(теж виглядає якось так C:\Users\...\Google\Chrome\User Data\Default)

4. В файл accounts записати лігини і паролі 

5. ОБОВЯЗКОВО закрити Google Chrome і вийти з .
